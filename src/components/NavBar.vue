...
<section class="nav-bar" :class="{'nav-bar_hidden': isNavHidden}">
    <ul class="nav-bar__nav-links nav-bar__nav-links">
        <router-link to="/#tshirts">
            <li class="nav-bar__nav-link" :class="{'nav-bar__nav-link_active':tshirtsOn}" @click="this.$store.commit('items/openTshirtsSection')">T-shirts</li>
        </router-link>
        <router-link to="/#hoodies">
            <li class="nav-bar__nav-link" :class="{'nav-bar__nav-link_active':hoodiesOn}" @click="this.$store.commit('items/openHoodiesSection')">Hoodies</li>
        </router-link>
    </ul>
    <router-link to="/auth">
...
<div class="nav-bar__btn nav-bar__btn_centered" @click="toggleNav">
    <svg class="nav-bar__arrow" :class="[isNavHidden ? 'nav-bar__arrow_rotated' : '']">
